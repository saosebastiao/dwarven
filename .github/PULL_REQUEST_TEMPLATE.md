...
<!-- Dwarven core contains general-purpose skills and infrastructure
...
| Claude Code version | Model | Model version/ID |
|---------------------|-------|------------------|
|                     |       |                  |
...
- [ ] If this is a skills change: I used `dwarven:writing-skills` and
