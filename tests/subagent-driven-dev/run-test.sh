...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/dwarven
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/dwarven-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using dwarven:subagent-driven-development. The plan is at: $PLAN_PATH"
